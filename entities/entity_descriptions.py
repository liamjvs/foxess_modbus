...
def _pv_entities() -> Iterable[EntityFactory]:
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39070], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.F_G3),
        ],
        name="PV1 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv1_current",
        addresses=[
            ModbusAddressesSpec(holding=[39071], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.F_G3),
        ],
        name="PV1 Current",
        scale=0.01,
    )
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39072], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.F_G3),
        ],
        name="PV2 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv2_current",
        addresses=[
            ModbusAddressesSpec(holding=[39073], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.F_G3),
        ],
        name="PV2 Current",
        scale=0.01,
    )
...
def _h1_current_voltage_power_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39123], models=Inv.F_G3),
        ],
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39135], models=Inv.F_G3),
        ],
        name="Inverter Power",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
...
def _inverter_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39139], models=Inv.H3_PRO_122 | Inv.F_G3),
        ],
        entity_registry_enabled_default=False,
        name="Grid Frequency",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39141], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.F_G3),
        ],
        name="Inverter Temp",
    ...
    yield _solar_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39152], models=Inv.F_G3),
        ],
        scale=0.01,
    )
...
def _f_g3_entities() -> Iterable[EntityFactory]:
    """Entities specific to the FoxESS Smart GW-M1 WiFi dongle (Inv.F_G3).

    Solar-only string inverter (F-Series G3) — no battery.
    Register map confirmed by simultaneous cloud API + Modbus cross-reference:

      39070 = PV1 Voltage         (0.1 V)   → shared with H1_G2_SET
      39071 = PV1 Current         (0.01 A)  → shared with H1_G2_SET
      39072 = PV2 Voltage         (0.1 V)   → shared with H1_G2_SET (pv2_voltage entity)
      39073 = PV2 Current         (0.01 A)  → shared with H1_G2_SET
      39123 = Grid Voltage R      (0.1 V)   → shared via rvolt entity
      39135 = AC Output Power     (1 W)     → shared via rpower entity (scale 0.001 → kW)
      39139 = Grid Frequency      (0.01 Hz) → shared with H3_PRO
      39141 = Inverter Temp       (0.1 °C)  → shared with H3_PRO
      39152 = Solar Energy Today  (0.01 kWh)→ shared via solar_energy_today entity
    """
    # PV1 Power: no direct register; compute as PV1 Voltage × PV1 Current → kW.
    yield ModbusLambdaSensorDescription(
        key="pv1_power",
        models=[EntitySpec(register_types=[RegisterType.HOLDING], models=Inv.F_G3)],
        sources=["pv1_voltage", "pv1_current"],
        method=lambda values: round(values[0] * values[1] / 1000, 3),
        name="PV1 Power",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement="kW",
    ...
    # PV2 Power: compute as PV2 Voltage (reg 39072) × PV2 Current (reg 39073) → kW.
    yield ModbusLambdaSensorDescription(
        key="pv2_power",
        models=[EntitySpec(register_types=[RegisterType.HOLDING], models=Inv.F_G3)],
        sources=["pv2_voltage", "pv2_current"],
        method=lambda values: round(values[0] * values[1] / 1000, 3),
        name="PV2 Power",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
